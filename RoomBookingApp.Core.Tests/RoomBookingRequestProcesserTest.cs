...
namespace RoomBookingApp.Core
{
    ...
    {
        private RoomBookingRequestProcesser _processor;
        private RoomBookingRequest _request;
        private Mock<IRoomBookingService> _roomBookingServiceMock;
        private List<Room> _availableRooms;

        public RoomBookingRequestProcesserTest()
        {
            //Arrange
            ...
            _processor = new RoomBookingRequestProcesser(_roomBookingServiceMock.Object);
        }
